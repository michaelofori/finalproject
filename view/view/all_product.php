...
<head>
    <meta charset="utf-8">
    <title>Kemdar Elecrtonics</title>
...
<body>
        ...
        <div class="row px-xl-5">
                ...
                <div id="header-carousel" class="carousel slide carousel-fade mb-30 mb-lg-0" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item position-relative active" style="height: 430px;">
                            <img class="position-absolute w-100 h-100" src="img/2020-05-07-product-3.jpg" style="object-fit: cover;">
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
                                    <h1 class="display-4 text-white mb-3 animate__animated animate__fadeInDown">Quailty Laptops</h1>
                                    <p class="mx-md-5 px-5 animate__animated animate__bounceIn">Lastest Macbooks at affordable prices</p>
                                    <a class="btn btn-outline-light py-2 px-4 mt-3 animate__animated animate__fadeInUp" href="#">Shop Now</a>
                                </div>
                            </div>
                        </div>
                        <div class="carousel-item position-relative" style="height: 430px;">
                            <img class="position-absolute w-100 h-100" src="img/ipad-pro-intro3.jpg" style="object-fit: cover;">
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
                                    <h1 class="display-4 text-white mb-3 animate__animated animate__fadeInDown">Tablets</h1>
                                    <p class="mx-md-5 px-5 animate__animated animate__bounceIn">Best Ipads</p>
                                    <a class="btn btn-outline-light py-2 px-4 mt-3 animate__animated animate__fadeInUp" href="#">Shop Now</a>
                                </div>
                            </div>
                        </div>
                        <div class="carousel-item position-relative" style="height: 430px;">
                            <img class="position-absolute w-100 h-100" src="img/41qE2tJ08eL._AC_SY350_.jpg" style="object-fit: cover;">
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
                                    <h1 class="display-4 text-white mb-3 animate__animated animate__fadeInDown">Camera</h1>
                                    <p class="mx-md-5 px-5 animate__animated animate__bounceIn">4k camera</p>
                                    <a class="btn btn-outline-light py-2 px-4 mt-3 animate__animated animate__fadeInUp" href="#">Shop Now</a>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-lg-4">
                <div class="product-offer mb-30" style="height: 200px;">
                    <img class="img-fluid" src="img/Samsung-Galaxy-Z-Flip4.jpg" alt="">
                ...
                <div class="product-offer mb-30" style="height: 200px;">
                    <img class="img-fluid" src="img/iphone__ky2k6x5u6vue_og.png" alt="">
                    <div class="offer-text">
                        <h6 class="text-white text-uppercase">Save 20%</h6>
                        <h3 class="text-white mb-3">Special Offer</h3>
                        <a href="" class="btn btn-primary">Shop Now</a>
                    ...
                    <a class="text-decoration-none" href="">
                        ...
                        <div class="cat-item d-flex align-items-center mb-4">
                            <div class="overflow-hidden" style="width: 100px; height: 100px;">
                                <img class="img-fluid" src="../images/k.png" alt="">
                            </div>
                            <div class="flex-fill pl-3">
                                <h6><?php echo ($item['cat_name']) ?></h6>
                                <small class="text-body">In Stock</small>
                            </div>
                        </div>
    ...
    <div class="container-fluid pt-5 pb-3">
        ...
        <div class="row px-xl-5">
            <?php
            $prod = select_allproduct_ctr();
            foreach ($prod as $item) {
            ?>
                <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                    <div class="product-item bg-light mb-4">
                        <div class="product-img position-relative overflow-hidden">
                            <img src="../images/product/<?php echo $item['product_image']; ?>" class="img-fluid w-100" alt="">
                            <div class="product-action">
                                ...
                                <a class="btn btn-outline-dark btn-square" href="detail.php?product_id=<?php echo ($item['product_id']); ?>"><i class="fa fa-eye"></i></a>
                                <a class="btn btn-outline-dark btn-square" href=""><i class="fa fa-search"></i></a>
                            </div>
                        </div>
                        <div class="text-center py-4">
                            <a class="h6 text-decoration-none text-truncate" href=""><?php echo ($item['product_title']) ?> </a>
    ...
    <div class="container-fluid pt-5 pb-3">
        <div class="row px-xl-5">
            ...
            <div class="col-md-6">
                <div class="product-offer mb-30" style="height: 300px;">
                    <img class="img-fluid" src="img/717lT2M842L._AC_SL1500_.jpg" alt="">
                    <div class="offer-text">
                        <h6 class="text-white text-uppercase">Save 20%</h6>
                        <h3 class="text-white mb-3">Special Offer</h3>
                        <a href="" class="btn btn-primary">Shop Now</a>
    ...
    <!-- Adverts -->
    <div class="container-fluid pt-5 pb-3">
        <h2 class="section-title position-relative text-uppercase mx-xl-5 mb-4"><span class="bg-secondary pr-3">Sponored</span></h2>
        <div class="row px-xl-5">
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                <div class="product-item bg-light mb-4">
                    <div class="product-img position-relative overflow-hidden">
                        <img class="img-fluid w-100" src="img/output-onlinepngtools.png" alt="">
                        <!-- <div class="product-action">
                    ...
                    <div class="text-center py-4">
                        <a class="h6 text-decoration-none text-truncate" href="">Kemdar Electronics</a>
                        <!-- <div class="d-flex align-items-center justify-content-center mt-2">
