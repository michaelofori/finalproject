...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Kemdar Electronics - Contact</title>
    ...
    <!-- Navbar End -->
        ...
        <!-- Breadcrumb End -->
        <div class="container-fluid">
            <section class="elementor-section elementor-top-section elementor-element elementor-element-090c9a8 elementor-section-full_width elementor-section-height-default elementor-section-height-default" data-id="090c9a8" data-element_type="section">
                <div class="elementor-container elementor-column-gap-no">
                    <div class="elementor-row">
                        <div class="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-67ca3ac" data-id="67ca3ac" data-element_type="column">
                            <div class="elementor-column-wrap elementor-element-populated">
                                <div class="elementor-widget-wrap">
                                    <div class="elementor-element elementor-element-c7bb195 elementor-widget elementor-widget-laundry_team" data-id="c7bb195" data-element_type="widget" data-widget_type="laundry_team.default">
                                                ...
                                                <div class="container container-fluid-lg">
                                                    <div class="title-block text-center">
                                                        <div class="title-block__label">
                                                            Our Team </div>
                                                        <h4 class="title-block__title">Men In Tech</h4>
                                                        <div class="title-block__text">
                                                            Our team’s goal each day is to earn
                                                            your business with each visit and to
                                                            make<br> your experience with us the
                                                            absolute best. </div>
                                                    </div>
                                                </div>
                                            </div>
            ...
            <div class="col-lg-9 col-md-8">
                <div class="row pb-3">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 pb-1">
                        <div class="product-item bg-light mb-4">
                            <div class="product-img position-relative overflow-hidden">
                                <img class="img-fluid w-100" ; src="img/ayeyi.jpg" alt="">
                            </div>
                            <div class="text-center py-4">
                                <a class="h6 text-decoration-none text-truncate" href="">IOS devices</a>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 pb-1">
                        <div class="product-item bg-light mb-4">
                            <div class="product-img position-relative overflow-hidden">
                                <img class="img-fluid w-100" ; src="img/IMG_0015.jpg" alt="">
                            </div>
                            <div class="text-center py-4">
                                <a class="h6 text-decoration-none text-truncate">Mobile Repairs</a>
                                <div class="d-flex align-items-center justify-content-center mt-2">
                                    <h5>Michael Ofori</h5>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 pb-1">
                        <div class="product-item bg-light mb-4">
                            <div class="product-img position-relative overflow-hidden">
                                <img class="img-fluid w-100" src="img/bright.jpg" alt="">
                            </div>
                            <div class="text-center py-4">
                                <a class="h6 text-decoration-none text-truncate" href="">Laptop Repairs</a>
                                <div class="d-flex align-items-center justify-content-center mt-2">
                                    <h5>Bright Augustt</h5>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row px-xl-5">
                    ...
                    <div class="col-lg-5 mb-5">
                        <div class="bg-light p-30 mb-30">
                            <iframe style="width: 100%; height: 250px;" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15882.144237601113!2d-0.08402264999999999!3d5.63527495!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xd81109a77dd0c2d2!2sThe%20Place%20Tema!5e0!3m2!1sen!2sgh!4v1669847637964!5m2!1sen!2sgh" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
                        </div>
                        <div class="bg-light p-30 mb-3">
                            <p class="mb-2"><i class="fa fa-map-marker-alt text-primary mr-3"></i>Spintex Road</p>
                            <p class="mb-2"><i class="fa fa-envelope text-primary mr-3"></i>michaelofori87@gmail.com</p>
                            <p class="mb-2"><i class="fa fa-phone-alt text-primary mr-3"></i>+233 20 95 35 914</p>
                        </div>
                    </div>
                </div>
            </div>
