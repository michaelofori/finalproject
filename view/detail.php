...
<head>
    <meta charset="utf-8">
    <title>Kemdar Electronics - View Product</title>
    <link rel="icon" href="../images/templogo.png" type="image/gif">
        ...
        <div class="row px-xl-5">
                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner bg-light">
                        <div class="carousel-item active">
                            <img class="w-100 h-100" src="../images/product/<?php echo ($prod['product_image']) ?>" alt="Image">
                        </div>
            ...
            <div class="col-lg-7 h-auto mb-30">
                <div class="h-100 bg-light p-30">
                    <h3><?php
                echo ("Title:  ");
                        echo ($prod['product_title']) ?></h3>
                   
                    <h3 class="font-weight-semi-bold mb-4"><?php echo (" Ghc  ");
                        echo ($prod['product_price']) ?></h3>
                    <p class="mb-4"><?php echo ("Description:  ");
                    echo ($prod['product_desc']) ?></p>
                    <div class="d-flex align-items-center mb-4 pt-2">
                        ...
                        <a class="btn btn-primary px-3" href="all_product.php"><i class="fa fa-reply mr-1"></i>Go back</a>
                    </div>
