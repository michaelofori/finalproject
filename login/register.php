		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section">Kemdar Electronics</h2>
				</div>
			</div>
			<div class="row justify-content-center">
					...
					<div class="login-wrap py-5">
						...
						<form action="../actions/registerprocess.php" method="post" class="login-form">
							...
							<div class="form-group">
								...
								<button type="submit" id="register_user" name="register_user" onclick="sweet()" class="btn form-control btn-primary rounded submit px-3">Get Started</button>
							</div>
						</form>
...
<!-- <script type="text/javascript">
		$(document).ready(function wrong_pass_alert() {
