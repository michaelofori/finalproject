    ...
    <div id="page-wrapper">
      <div class="main-page">
        <div class="media">
          ...
          <h2 class="title1">Update Brand</h2>
          <div class="bs-example5 widget-shadow" data-example-id="default-media">
            <!-- Button trigger modal -->
            <form action="../actions/edit_brand.php" method="post">
              <!-- update name -->
              <div class="mb-3">
              <input type="hidden" name="brand_id" value=" <?php echo $result['brand_id']; ?> ">
              <label for="title" class="form-label">Previous Brand name</label>
              <input type="text" class="form-control" placeholder=" <?php echo $result['brand_name']; ?> " id="brand_name" name="brand_name" id="brand_name"><br>
              <!-- contact -->
              </div>
              <!-- submit button -->
