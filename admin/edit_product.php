...
if (isset($_POST['edit'])) {
  ...
  $result = select_oneproduct_ctr($product_id);
}
?>
...
<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page">
              ...
              <input type="hidden" name="image" value=" <?php echo $result['product_image']; ?> ">

								<div class="mb-3">
                <input type="hidden" name="product_id" value=" <?php echo $result['product_id']; ?> ">
									<label for="description" class="form-label">Product Title</label>
									<textarea class="form-control" id="description" name="product_title" placeholder="  " id="product_title" name="product_title" id="product_title" rows="1"><?php echo $result['product_title']; ?></textarea>
                  <!-- <input  class="form-control" type="text" value=" <?php echo $result['product_title']; ?> " id="product_title" name="product_title" id="product_title"><br> -->
								</div>

								<div class="mb-3">
									<label for="price" class="form-label">Product price</label>
									<input type="number" class="form-control"  placeholder=" <?php echo $result['product_price']; ?> " id="product_price" name="product_price" id="product_price" id="price" name="product_price" aria-describedby="emailHelp">
                  <!-- <input type="text" value=" <?php echo $result['product_price']; ?> " id="product_price" name="product_price" id="product_price"><br> -->
								</div>

								<div class="mb-3">
									<label for="description" class="form-label">Product Description</label>
									<textarea class="form-control" value="  " id="product_desc" name="product_desc" id="product_desc" id="description" name="product_desc" rows="3"><?php echo $result['product_desc']; ?></textarea>
                  <!-- <input type="text" value=" <?php echo $result['product_desc']; ?> " id="product_desc" name="product_desc" id="product_desc"><br> -->
								</div>
								...
								<div class="mb-3">
									...
									<textarea class="form-control" placeholder="  " id="product_keywords" name="product_keywords" id="product_keywords" rows="1"><?php echo $result['product_keywords']; ?></textarea>
                  <!-- <input type="text" value=" <?php echo $result['product_keywords']; ?> " id="product_keywords" name="product_keywords" id="product_keywords"><br> -->
								</div>

								<button type='submit' class='btn btn-primary' value="update" name="edit" >Submit</button>
							</form>
